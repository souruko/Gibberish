--[[
    EffectItem for Collection (ListBox)
]]
...
function EffectItem:Constructor(parent, index, data, width)
...
function EffectItem:Build()
    ...
    self.MouseClick = function()
        ...
        self.parent:EffectItemClicked(self.index)
    end

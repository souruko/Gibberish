--[[
    CollectionLists child for ChatItems
]]


ChatControl = class( Turbine.UI.Control )

function ChatControl:Constructor(parent, width, data)
...
function ChatControl:Build()
    ...
    self.token_l:SetText(L.ChatItemTokenText..self.data.chatType)
    ...
    self.MouseClick = function()
        self.parent:ChatControlClicked(self.token, nil, nil)
    end
